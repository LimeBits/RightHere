...
The diagnostic text includes app version, macOS version, CPU architecture, template counts, enabled file extensions, extension response timing, recent extension events, and relevant local paths. It does not include template file contents or user file contents.
